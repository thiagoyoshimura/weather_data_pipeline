...
subprocess.run([sys.executable, os.path.join(BASE_DIR, "ingest_weather_api.py")], check=True)

# Step 2: Transform data
print("\n Running transformation script...")
subprocess.run([sys.executable, os.path.join(BASE_DIR, "transform_data.py")], check=True)
